...
```{r fig-resize-local, fig.height=3, fig.margin=TRUE, fig.width=6}

```{r fig-resize-local, fig.height=3, fig.margin=TRUE, fig.width=6, message=TRUE, warning=TRUE, paged.print=TRUE}
...
```{r theme-highlight, echo=FALSE, fig.height=3, fig.margin=TRUE, fig.width=6}
